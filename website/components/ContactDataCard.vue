...
<template>
    <div class="space-y-4  p-4 min-w-[350px]">
    <div v-for="(contact, index) in contacts" :key="index" class="p-5 max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden md:max-w-lg">
